...
class WalletsControllerTest < ActionController::TestCase
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post :create, wallet: { credit_card_display: @wallet.credit_card_display, lemonway_id: @wallet.lemonway_id, user_id: @wallet.user_id }
    end
  ...
  test "should update wallet" do
    patch :update, id: @wallet, wallet: { credit_card_display: @wallet.credit_card_display, lemonway_id: @wallet.lemonway_id, user_id: @wallet.user_id }
    assert_redirected_to wallet_path(assigns(:wallet))
  end
