...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { deliveryman_id: @availability.deliveryman_id, enabled: @availability.enabled, schedule_id: @availability.schedule_id, shop_id: @availability.shop_id }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { deliveryman_id: @availability.deliveryman_id, enabled: @availability.enabled, schedule_id: @availability.schedule_id, shop_id: @availability.shop_id }
    assert_redirected_to availability_path(assigns(:availability))
  end
